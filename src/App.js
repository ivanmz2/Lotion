...
import './index.css';
import NoteEditor from './NoteEdition';
import Sidebar from './Menu';
import Header from './top';
import NoteViewer from './StoreNote';
        ...
        <Routes>
          ...
          <Route
            ...
            element={
              ...
              >
                <div className={`no-active-note ${!showSidebar ? 'full-width' : ''}`}>Select a stored note, or create a new note.</div>
              </Layout>
            }
          />
          <Route
